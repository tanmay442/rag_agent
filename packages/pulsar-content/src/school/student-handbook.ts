// Gardenia Public School — Student & Parent Handbook.
// Hand-rolled PDF (we avoid pdf-lib here to keep this fixture
// rendering identical to the one the script has shipped for
// years, which the test fixtures assert against byte-for-byte
// after PDF version rounding).
...
export function writeStudentHandbook(outPath: string): string {
